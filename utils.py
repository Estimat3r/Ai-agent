...
def print_agent_flow_chart() -> None:
    ...
    INPUT: Image (224x224, normalized)
         |
    [1] JUDGE: Vision Analysis (Saltlux API)
    ...
    [3] ACT: Decision Making
        - If confidence > threshold: Output prediction
        - Else: Trigger re-analysis
         |
    [4] VERIFY: Validation & Confirmation
    ...
    - Semiconductor manufacturing defect classification
    - Critical defect detection (package, leads)
